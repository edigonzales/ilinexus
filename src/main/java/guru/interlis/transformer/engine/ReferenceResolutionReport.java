...
public record ReferenceResolutionReport(
    ...
    public static final class Builder {
        ...
        public Builder resolved(int v) { this.resolved = v; return this; }
        public Builder unresolvedOptional(int v) { this.unresolvedOptional = v; return this; }
        public Builder unresolvedMandatory(int v) { this.unresolvedMandatory = v; return this; }
        public Builder ambiguous(int v) { this.ambiguous = v; return this; }
        public Builder typeMismatch(int v) { this.typeMismatch = v; return this; }
        public Builder cardinalityViolations(int v) { this.cardinalityViolations = v; return this; }
        public Builder totalDeferred(int v) { this.totalDeferred = v; return this; }
